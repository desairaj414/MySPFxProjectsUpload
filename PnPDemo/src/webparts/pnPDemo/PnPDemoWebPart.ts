...
import PnPDemo from './components/PnPDemo';
import { IPnPDemoProps } from './components/IPnPDemoProps';
...
export default class PnPDemoWebPart extends BaseClientSideWebPart<IPnPDemoWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IPnPDemoProps> = React.createElement(
      PnPDemo,
      {
